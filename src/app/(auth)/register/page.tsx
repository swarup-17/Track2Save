...
export default function RegisterPage() {
  ...
  const [verificationStep, setVerificationStep] = useState<"initial" | "otp">("initial");
  ...
  const handleSendOtp = async () => {
    try {
      setLoading(true);
      const res = await axios.post("/api/users/sendOtp", {
        to: phone,
        channel: "sms",
        locale: "en",
      });
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Verify OTP
      const verifyRes = await axios.post("/api/users/verifyOtp", {
        to: phone,
        code: otp,
      });
          ...
          >
            {loading ? (
              <span className="flex items-center justify-center">
                ...
                {verificationStep === "otp" ? "Verifying..." : "Sending OTP..."}
              </span>
            ) : verificationStep === "otp" ? "Verify & Register" : "Send OTP"}
          </Button>
        </form>
